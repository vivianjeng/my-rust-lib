...
int64_t uniffi_foobar_fn_method_safedivision_perform(
    void *ptr, int64_t lhs, int64_t rhs, RustCallStatus *uniffi_out_err);
RustBuffer uniffi_foobar_fn_func_greet(RustBuffer who,
                                       RustCallStatus *uniffi_out_err);
void *
...
void ffi_foobar_rust_future_complete_void(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
uint16_t uniffi_foobar_checksum_func_greet();
...
NativeFoobar::NativeFoobar(
  ...
  props["ubrn_uniffi_foobar_fn_func_greet"] =
      jsi::Function::createFromHostFunction(
          rt, jsi::PropNameID::forAscii(rt, "ubrn_uniffi_foobar_fn_func_greet"),
          1,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_uniffi_foobar_fn_func_greet(rt, thisVal, args,
                                                         count);
          });
  ...
  props["ubrn_uniffi_foobar_checksum_func_greet"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(rt,
                                    "ubrn_uniffi_foobar_checksum_func_greet"),
          0,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_uniffi_foobar_checksum_func_greet(rt, thisVal,
                                                               args, count);
          });
...
jsi::Value NativeFoobar::cpp_uniffi_foobar_fn_func_greet(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
  RustCallStatus status =
      uniffi::foobar::Bridging<RustCallStatus>::rustSuccess(rt);
  auto value = uniffi_foobar_fn_func_greet(
...
jsi::Value NativeFoobar::cpp_uniffi_foobar_checksum_func_greet(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
  auto value = uniffi_foobar_checksum_func_greet();
